...
public class ZTestNGSkipBeforeClass1 extends ZTestNGSkipBeforeClassBase{
//public class ZTestNGSkipBeforeClass1{
    
    @BeforeClass(dependsOnMethods = "bc", alwaysRun=true)
